 ...
 *  @dev This contract implements Chainlink VRFV2 and Chainlink Keepers
 */
contract Raffle is VRFConsumerBaseV2, KeeperCompatibleInterface {
    ...
    constructor(
        address vrfCoordinatorV2, // contract -- deploy mocks for tests
        uint256 entranceFee,
        bytes32 gasLane,
    ...
    /**
     * @dev This is the function that the Chainlink keeper nodes call when conditions are met.
     * Essentially looks for `upkeepNeeded` to be true.
